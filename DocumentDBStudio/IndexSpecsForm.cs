    ...
    public partial class IndexSpecsForm : Form
    {
        ...
        public void SetIndex(Index index)
        {
            ...
            if (index.Kind == IndexKind.Hash)
            {
                ...
                this.tbPrecision.Text = ((HashIndex)index).Precision.HasValue ? ((HashIndex)index).Precision.Value.ToString() : string.Empty; 
            }
            else
            {
                ...
                this.tbPrecision.Text = ((RangeIndex)index).Precision.HasValue ? ((RangeIndex)index).Precision.Value.ToString() : string.Empty;
            }
        }
